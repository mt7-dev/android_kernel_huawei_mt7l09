...
{
    return (void*)ncm_vendor_open(enDevType, pu32NcmDevId);
}
...
{
    return ncm_vendor_write((u32)handle, pPktEncap, net_priv);
}
...
{
    return ncm_vendor_ioctl((u32)handle, enNcmCmd, param);/* [false alarm]:fortify disable */
}
...
{
    return ncm_vendor_close(enDevType, (u32)handle);/* [false alarm]:fortify disable */
}
