...
s32 bsp_mem_init(void)
{
    ...
    sg_pAllocSizeTbl = (u32*)((unsigned long)MEM_CTX_ADDR + MEM_CTX_RESERVED);
    sg_pIccAllocInfo = (MEM_ALLOC_INFO*)((unsigned long)MEM_CTX_ADDR + sizeof(sg_AllocListSize) + MEM_CTX_RESERVED);
