...
VOS_UINT32    g_aulModem0ErrLogDetail[OM_MAX_MODULE_ID]= {
                         I0_WUEPS_PID_MMC,I0_UEPS_PID_MTA,WUEPS_PID_OM_CALLBACK, I0_WUEPS_PID_USIM,
                         PS_PID_IMSA,     I0_UEPS_PID_GAS,I0_WUEPS_PID_CC,               0,
...
VOS_UINT32    g_aulModem1ErrLogDetail[OM_MAX_MODULE_ID]= {
                         I1_WUEPS_PID_MMC,I1_UEPS_PID_MTA,WUEPS_PID_OM_CALLBACK, I1_WUEPS_PID_USIM,
                         PS_PID_IMSA,     I1_UEPS_PID_GAS,I1_WUEPS_PID_CC,               0,
...
VOS_UINT32 OM_AcpuRcvErrLogMsgCheck(OM_RCV_DATA_INFO_STRU *pstOmRcvDataInfo, VOS_UINT32 *pulSendPidCount)
{
    ...
    OM_ERR_LOG2("OM_AcpuRcvMsgCheck:error log Module id is %d, g_stOmAppMsgRecord.ulErrLogReportSend is %d!\r\n ",
