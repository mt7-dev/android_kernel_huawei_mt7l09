...
/*lint --e{944,506,525,64,119,101,132,537,958,438,830,752,762,713,732} */

/*lint -e534 -e550 -e650 -e715 -e734 -e774 -e826 -e831 -e944 -e506*/
/* ecs */
#include <vxWorks.h>
#include <logLib.h>
#include <semLib.h>
                             ...
                             u32                 DataLength)
{
    ...
    {
        pState->eCurrentState = PL131_STATE_RX;
