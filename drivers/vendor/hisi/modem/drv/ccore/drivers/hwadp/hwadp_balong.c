...
BSP_IP_BASE_ADDR_INFO g_ulIPBaseAddr[BSP_IP_TYPE_BUTTOM + 1] = {
    ...
    {BSP_IP_TYPE_HDLC,			HI_HDLC_REGBASE_ADDR},
	{BSP_IP_TYPE_CTU,			HI_CTU_BASE_ADDR}, /* 这个地址保证多模平台可正常工作，现由BSP_CONFIG_V7R2_ASIC宏控制 */
    {BSP_IP_TYPE_COMMON,		HI_BBP_COMM_ON_BASE_ADDR},
    {BSP_IP_TYPE_BBPDMA,		HI_BBP_DMA_BASE_ADDR},
	{BSP_IP_TYPE_BBPDBG,		HI_BBP_DBG_BASE_ADDR},
	{BSP_IP_TYPE_BBPSRC,		HI_BBP_SRC_BASE_ADDR},
	{BSP_IP_TYPE_SOCP,			HI_SOCP_REGBASE_ADDR},
...
BSP_MEM_ADDR_SIZE_INFO g_ulMemBaseSize[] = {
    ...
    {BSP_DDR_TYPE_SRAM_TLPHY,                        SRAM_TLPHY_ADDR,                           SRAM_TLPHY_SIZE},
    {BSP_DDR_TYPE_SHM_TEMPERATURE,                   SHM_MEM_TEMPERATURE_ADDR,                  SHM_MEM_TEMPERATURE_SIZE},
    ...
    {BSP_DDR_TYPE_SRAM_MAILBOX_PROTECT_FLG,          DSP_MAILBOX_PROTECT_FLAG_ADDR,             DSP_MAILBOX_PROTECT_FLAG_SIZE},
...
u32 BSP_GetIPBaseAddr(BSP_IP_TYPE_E enIPType)
{
