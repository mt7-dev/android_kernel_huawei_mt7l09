...
static int BSP_HwMem_Init(void)
{
   ...
   //g_stAxiSectInfo[BSP_AXI_SECT_TYPE_DICC].pSectPhysAddr = (u32)MEMORY_AXI_DICC_ADDR  - HI_SRAM_MEM_ADDR_VIRT + HI_SRAM_MEM_ADDR;
    ...
    g_stAxiSectInfo[BSP_AXI_SECT_TYPE_TTF_BBP].pSectVirtAddr = (void *)((unsigned long)SRAM_GU_MAC_HEADER_ADDR);
    g_stAxiSectInfo[BSP_AXI_SECT_TYPE_TTF_BBP].pSectPhysAddr = (void *)((unsigned long)SRAM_V2P(SRAM_GU_MAC_HEADER_ADDR));

    g_stDdrSectInfo[BSP_DDR_SECT_TYPE_TTF].pSectVirtAddr = (void *)((unsigned long)ECS_TTF_BASE_ADDR_VIRT);
    g_stDdrSectInfo[BSP_DDR_SECT_TYPE_NV].pSectVirtAddr = (void *)((unsigned long)ECS_NV_BASE_ADDR_VIRT);
    g_stDdrSectInfo[BSP_DDR_SECT_TYPE_DICC].pSectVirtAddr = (void *)((unsigned long)ECS_TTF_DICC_ADDR_VIRT);
    ...
    g_stDdrSectInfo[BSP_DDR_SECT_TYPE_SHARE_MEM].pSectVirtAddr = (void *)((unsigned long)DDR_SHARED_MEM_VIRT_ADDR);
...
void* DRV_DDR_VIRT_TO_PHY(void* ulVAddr)
{
    ...
    if((ulVAddr >= (void *)((unsigned long)DDR_SHARED_MEM_VIRT_ADDR))
        && (ulVAddr < (void *)((unsigned long)SHM_MEM_TOP_ADDR)))
    {
        return (void*)SHD_DDR_V2P(ulVAddr);
    }
    if((ulVAddr >= (void *)((unsigned long)DDR_GU_ADDR_VIRT))
        && (ulVAddr <= (void*)(DDR_GU_ADDR_VIRT + DDR_GU_SIZE)))
    {
        return (void*)(ulVAddr - DDR_GU_ADDR_VIRT + DDR_GU_ADDR);
    }
...
{
    return (ulVAddr - (void *)ECS_TTF_BASE_ADDR_VIRT + (void*)ECS_TTF_BASE_ADDR);
}
...
{
    return (ulVAddr - (void *)HI_SRAM_MEM_ADDR_VIRT + (void*)HI_SRAM_MEM_ADDR);
}
...
{
    return (void *)(ulPAddr - (void*)HI_SRAM_MEM_ADDR + HI_SRAM_MEM_ADDR_VIRT);
}
...
void show_shared_ddr_status(void)
{
	...
	printf("%-30s%10s%10s%10s\n", "name", "phy addr", "virt addr", "size");
	printf("%-30s%10lx%10p%10x\n", "SHM_MEM_APPA9_PM_BOOT_ADDR", SHD_DDR_V2P(SHM_MEM_APPA9_PM_BOOT_ADDR), (void *)((unsigned long)SHM_MEM_APPA9_PM_BOOT_ADDR), SHM_MEM_APPA9_PM_BOOT_SIZE);
	printf("%-30s%10lx%10p%10x\n", "SHM_MEM_MDMA9_PM_BOOT_ADDR", SHD_DDR_V2P(SHM_MEM_MDMA9_PM_BOOT_ADDR), (void *)((unsigned long)SHM_MEM_MDMA9_PM_BOOT_ADDR), SHM_MEM_MDMA9_PM_BOOT_SIZE);
