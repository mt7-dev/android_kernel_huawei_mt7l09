...
USER_AS_DEFINES     :=
USER_AS_FLAGS       :=-mcpu=cortex-m3 -mthumb -D__ASSEMBLY__ -x assembler-with-cpp -MD -c -D__CMSIS_RTOS -D__M3_OS__
USER_AS_OPTIM_FLAGS :=
USER_C_FLAGS        :=-mcpu=cortex-m3 -mthumb -MD -c -D__CMSIS_RTOS
...
$(LOCAL_IMAGE_FILE) : $(LOCAL_LIBRARY) | do_post_build_before
	...
	$(Q)$(OBJDUMP) -D $(LOCAL_LIBRARY) > $(basename $@).asm
