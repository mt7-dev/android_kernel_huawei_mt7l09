...
VOS_UINT32 DRVAGENT_RcvDrvAgentMsidQryReq(VOS_VOID *pMsg)
{
    ...
    /*获取硬件模块名*/
    lRslt = DRV_MEM_VERCTRL(stDrvAgentMsidQryCnf.acModelId,
    ...
    /*获取软件版本号*/
    lRslt = DRV_MEM_VERCTRL(stDrvAgentMsidQryCnf.acSoftwareVerId,
...
VOS_UINT32 DRVAGENT_RcvDrvAgentAppdmverReq(VOS_VOID *pMsg)
{
    ...
    lRet = DRV_MEM_VERCTRL(stEvent.acPdmver, AT_MAX_PDM_VER_LEN, VER_PDM, VERIONREADMODE);
...
VOS_UINT32 DRVAGENT_RcvDrvAgentPfverQry(VOS_VOID *pMsg)
{
    ...
    /* 读取编译时间 */
    pcVerTime = DRV_GET_VERSION_TIME();
    ...
    lRet = DRV_MEM_VERCTRL((VOS_INT8 *)stEvent.stPfverInfo.aucPfVer,
...
VOS_UINT32 DRVAGENT_RcvDrvAgentVertimeQry(VOS_VOID *pMsg)
{
    ...
    /* 调底软接口获取编译时间 */
    pucVerTime = DRV_GET_VERSION_TIME();
...
VOS_UINT32 DRVAGENT_RcvDrvAgentHardwareQry(VOS_VOID *pMsg)
{
    ...
    lRslt = DRV_MEM_VERCTRL((VOS_INT8 *)(stHardwareQryCnf.aucHwVer),
...
VOS_UINT32 DRVAGENT_RcvDrvAgentFullHardwareQry(VOS_VOID *pMsg)
{
    ...
    /*获取软件版本号*/
    lRslt = DRV_MEM_VERCTRL((VOS_INT8 *)(stFullHardwareQryCnf.aucRevisionId),
...
VOS_UINT32 DRVAGENT_RcvDrvAgentDeviceVersionQry(VOS_VOID *pMsg)
{
    ...
    if(DRV_INTERFACE_RSLT_OK != DRV_MEM_VERCTRL((VOS_INT8 *)(stVersionQryCnfInfo.stInterHwVer.aucHwVer),
                                                             TAF_MAX_HARDWARE_LEN,
                                                             VER_HARDWARE,
                                                             VERIONREADMODE))
    {
...
VOS_UINT32 DRVAGENT_RcvDrvAgentSARReductionSet(VOS_VOID *pMsg)
{
    ...
    /* 获取功率等级 */
    stSpyToDsp.ulSarReduction = (VOS_UINT32)pstMnAppReqMsg->aucContent[0];
