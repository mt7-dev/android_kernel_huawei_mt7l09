...
*/
/*****************************************************************************
 实体名称  : AMR_SID_RESET_FLG_ENUM
 功能描述  : AMR SID帧是否已经重置标记枚举
*****************************************************************************/
enum AMR_SID_RESET_FLG_ENUM
{
    AMR_SID_RESET_FLG_NO   = 0,
    AMR_SID_RESET_FLG_YES,
    AMR_SID_RESET_FLG_BUTT
};
...
typedef struct{
  ...
  enum Mode          prev_mode;
  Word16             shwOldResetFlag;   /* 解码器上帧reset标志 */
  Word16             shwRxSidResetFlg;
  Word16             shwReserved;
