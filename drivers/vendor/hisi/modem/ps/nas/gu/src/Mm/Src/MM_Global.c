...
const MM_CELL_FUN_TYPE        aMmEvent5[33] = {
    ...
    Mm_Cell_S25_E5,                                 /* S7 : MM IDLE PLMN SEARCH, NORMAL SERVICE         */
    Mm_Cell_S0_E5,                                  /* S8 : MM IDLE NO IMSI                             */
    ...
    Mm_Cell_S25_E5,                                 /* S15: WAIT FOR RR ACTIVE                          */
    ...
    Mm_Cell_S25_E5,                                 /* S24: LOCATION UPDATE REJECTED                    */
    Mm_Cell_S25_E5,                                 /* S25: WAIT FOR RR CONNECTION (IMSI DETACH)        */
    Mm_Cell_S25_E5,                                 /* S26: IMSI DETACH INITIATED                       */
