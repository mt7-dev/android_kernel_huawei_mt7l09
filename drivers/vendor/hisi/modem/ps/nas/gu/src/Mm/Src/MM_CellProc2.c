...
VOS_VOID Mm_Cell_S4_E5(VOS_VOID *pMsg)
{
    ...
    if ((g_MmGlobalInfo.MsCsInfo.OldLai.PlmnId.ulMcc
    ...
    /* 当配置成PS ONLY时，当处于limit service，不回复注册结果结果 */
    if (VOS_FALSE == NAS_MML_GetCsAttachAllowFlg())
    {
    ...
    {                                                                           /* 非A+I模式                                */
        ...
        else
        {
            ...
            if (g_MmGlobalInfo.ucNtMod == g_MmGlobalInfo.ucNewNtMod)
            {
                ...
                else if ( (MM_TIMER_RUNNING == gstMmTimer[MM_TIMER_T3212].ucTimerStatus)
                       &&  ( (g_MmGlobalInfo.MsCsInfo.CurLai.PlmnId.ulMcc == g_MmGlobalInfo.MsCsInfo.TempLai.PlmnId.ulMcc)
                          && (g_MmGlobalInfo.MsCsInfo.CurLai.PlmnId.ulMnc == g_MmGlobalInfo.MsCsInfo.TempLai.PlmnId.ulMnc)
                          && (g_MmGlobalInfo.MsCsInfo.CurLai.ulLac == g_MmGlobalInfo.MsCsInfo.TempLai.ulLac))
...
VOS_VOID Mm_Cell_S5_E5(VOS_VOID *pMsg)
{
    ...
    ulTimerStatus = NAS_MM_QryTimerStatus(MM_TIMER_T3211);
        ...
        else
        {
            ...
            if (g_MmGlobalInfo.ucNtMod != g_MmGlobalInfo.ucNewNtMod)
            {
                ...
                Mm_ComNetModeChange();
                  ...
                  && (g_MmGlobalInfo.MsCsInfo.CurLai.PlmnId.ulMcc == g_MmGlobalInfo.MsCsInfo.OldLai.PlmnId.ulMcc)
                  && (g_MmGlobalInfo.MsCsInfo.CurLai.PlmnId.ulMnc == g_MmGlobalInfo.MsCsInfo.OldLai.PlmnId.ulMnc)
                  && (g_MmGlobalInfo.MsCsInfo.CurLai.ulLac == g_MmGlobalInfo.MsCsInfo.OldLai.ulLac))
            {
                Mm_ComSysInfoHandleWithLaiNoChange(0);
                Mm_TimerStop(MM_TIMER_T3213);
            }
            else if ((g_MmGlobalInfo.MsCsInfo.CurLai.PlmnId.ulMcc
                != g_MmGlobalInfo.MsCsInfo.TempLai.PlmnId.ulMcc)
                || (g_MmGlobalInfo.MsCsInfo.CurLai.PlmnId.ulMnc
                != g_MmGlobalInfo.MsCsInfo.TempLai.PlmnId.ulMnc)
                || (g_MmGlobalInfo.MsCsInfo.CurLai.ulLac
...
VOS_VOID Mm_Cell_S17_E18(VOS_VOID *pMsg)
{
    ...
    if ( GMMMM_RAU_RESULT_COMBINED == pstCombinedRauAccpt->enRauResult )
    {
        ...
        pstCsSuccLai->stPlmnId.ulMnc
            = g_MmGlobalInfo.MsCsInfo.CurLai.PlmnId.ulMnc;
        pstCsSuccLai->aucLac[0] = (g_MmGlobalInfo.MsCsInfo.CurLai.ulLac >> 8) & (0xFF);
        pstCsSuccLai->aucLac[1] = (g_MmGlobalInfo.MsCsInfo.CurLai.ulLac) & (0x00FF);
...
VOS_VOID Mm_Cell_S18_E5(VOS_VOID *pMsg)
{
    ...
    if (MM_FALSE == Mm_RcvMmcSysInfoInd(pMsg))
    {
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_ERROR,
               "Mm_Cell_S18_E5:ERROR: Receive sys info error");                 /* 异常错误处理                             */
    }
                    ...
                    )
{
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {
            /* 通知SMS建立失败 */
            Mm_SndSmsRelInd(g_MmSmsEstReq.ulTi, NAS_MMCM_REL_CAUSE_MM_REJ_OTHER_CAUSES);
            return;
        }
                    ...
                    )
{
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {                                                                       /* 该TI的MM连接不存在                       */
            Mm_SndSsRelInd( pMmSsDataReq->ulTi, NAS_MMCM_REL_CAUSE_MM_REJ_OTHER_CAUSES);                               /* 通知SS建立失败                           */
        }
    }
                    ...
                    )
{
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {                                                                       /* 该TI的MM连接不存在                       */
            Mm_SndSmsRelInd(pMmSmsDataReq->ulTi, NAS_MMCM_REL_CAUSE_MM_REJ_OTHER_CAUSES);/* 通知SMS建立失败                          */
        }
    }
...
)
{
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {
            Mm_SndCcRelInd( g_MmCcRelReq.ulTransactionId, NAS_MMCM_REL_CAUSE_MM_REJ_OTHER_CAUSES);/* 通知CC指定释放的MM连接不存在             */
        }
...
VOS_VOID Mm_Cell_S1_E65(VOS_VOID *pRcvMsg)
{
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        Mm_SndSsRelInd(g_MmSsEstReq.ulTi, NAS_MMCM_REL_CAUSE_MM_NO_SERVICE);
