...
typedef struct
{
    MM_LAI_STRU                         CurLai; /* 当前驻留 LAI,收到系统消息时更新 */
    ...
    MM_LAI_STRU                         OldLai;                                 /* 最后一次注册成功的LAI */

    MM_LAI_STRU                         TempLai;                                /* 收到系统消息时临时保存的上次驻留的 LAI*/
...
#define MM_STATE_NULL                                   0
#define MM_IDLE_NO_CELL_AVAILABLE                       1
#define MM_IDLE_PLMN_SEARCH                             2
#define MM_IDLE_NORMAL_SERVICE                          3
#define MM_IDLE_LIMITED_SERVICE                         4
#define MM_IDLE_ATTEMPTING_TO_UPDATE                    5
#define MM_IDLE_LOCATION_UPDATE_NEEDED                  6
#define MM_IDLE_PLMN_SEARCH_NORMAL_SERVICE              7
#define MM_IDLE_NO_IMSI                                 8
#define WAIT_FOR_OUTGOING_MM_CONNECTION                 9
#define MM_CONNECTION_ACTIVE                            10
#define WAIT_FOR_NETWORK_COMMAND                        11
#define WAIT_FOR_RR_CONNECTION_MM_CONNECTION            12
#define WAIT_FOR_REESTABLISH_WAIT_FOR_REEST_REQ         13
#define WAIT_FOR_REESTABLISH_WAIT_FOR_EST_CNF           14
#define WAIT_FOR_RR_ACTIVE                              15
#define WAIT_FOR_ADDITIONAL_OUTGOING_MM_CONNECTION      16
#define LOCATION_UPDATING_PENDING                       17
#define IMSI_DETACH_PENDING                             18
#define MM_WAIT_FOR_ATTACH                              19
#define WAIT_FOR_RR_CONNECTION_LOCATION_UPDATING        22
#define LOCATION_UPDATING_INITIATED                     23
#define LOCATION_UPDATE_REJECTED                        24
#define WAIT_FOR_RR_CONNECTION_IMSI_DETACH              25
#define IMSI_DETACH_INITIATED                           26
#define PROCESS_CM_SERVICE_PROMPT                       27
#define TEST_CONTROL_ACTIVE                             31
#define MM_INTER_RAT_CHANGE                             32
