...
VOS_UINT32  NAS_EMM_ExportContextData(VOS_VOID)
{
    ...
    {
        /*打印错误*/
        NAS_LMM_PUBM_LOG_ERR("NAS_EMM_ExportContextData: MSG ALLOC ERR!");
        return VOS_FALSE;
    }
...
VOS_UINT32  NAS_ESM_ExportContextData(VOS_VOID)
{
    ...
    {
        /*打印错误*/
        NAS_LMM_PUBM_LOG_ERR("NAS_ESM_ExportContextData: MSG ALLOC ERR!");
        return VOS_FALSE;
    }
...
VOS_UINT32  NAS_ERABM_ExportContextData(VOS_VOID)
{
    ...
    {
        /*打印错误*/
        NAS_LMM_PUBM_LOG_ERR("NAS_ERABM_ExportContextData: MSG ALLOC ERR!");
        return VOS_FALSE;
    }
