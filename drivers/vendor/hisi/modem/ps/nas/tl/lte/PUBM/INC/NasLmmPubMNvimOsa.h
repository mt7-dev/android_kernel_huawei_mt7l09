...
extern VOS_UINT32  NAS_LMM_DecodeSimImsi(const NAS_NVIM_CTRL_TBL *pstNvCtrlTbl);
...
extern VOS_UINT32  NAS_LMM_DecodeNvACC(const  NAS_NVIM_CTRL_TBL *pstNvCtrlTbl  );
