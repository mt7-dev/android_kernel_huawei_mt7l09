...
/*在RRC_CONN_SET_INIT.WAIT_RRC_CONN状态收到RRC_MM_EST_CNF*/
extern VOS_UINT32  NAS_EMM_MsRrcConnEstInitSsWaitRrcConnMsgRrcMmEstCnf(VOS_UINT32 ulMsgId, VOS_VOID *pMsgStru);

/*在RRC_CONN_REL_INIT.WAIT_RRC_REL状态收到RRC_MM_REL_CNF*/
extern VOS_UINT32  NAS_EMM_MsRrcConnRelInitSsWaitRrcRelCnfMsgRrcMmRelCnf(VOS_UINT32 ulMsgId, const VOS_VOID *pMsgStru);

/*在RRC_CONN_REL_INIT.WAIT_RRC_REL状态收到RRC_MM_REL_IND*/
extern VOS_UINT32  NAS_EMM_MsRrcConnRelInitSsWaitRrcRelCnfMsgRrcMmRelInd(VOS_UINT32 ulMsgId, const VOS_VOID *pMsgStru);

extern VOS_UINT32  NAS_EMM_MsRrcConnRelInitSsWaitRrcRelMsgCnDetatchReq( VOS_UINT32 ulMsgId, const VOS_VOID *pMsgStru );
/*收到建连超时消息*/
extern VOS_UINT32  NAS_EMM_MsRrcConnEstInitSsWaitRrcConnMsgTIWaitRrcConnTO(VOS_UINT32 ulMsgId, const VOS_VOID *pMsgStru);

/* MRRC等待RRC连接建立,RRC上报REL IND消息 */
extern VOS_UINT32  NAS_EMM_MsRrcConnEstInitSsWaitRrcConnMsgRrcRelInd(VOS_UINT32 ulMsgId, VOS_VOID *pMsgStru);

/*收到释放超时消息*/
extern VOS_UINT32  NAS_EMM_MsRrcConnRelInitSsWaitRrcRelMsgTIWaitRrcRelTO(VOS_UINT32 ulMsgId,const VOS_VOID *pMsgStru);
...
extern VOS_UINT32  NAS_EMM_MsRrcConnEstInitSsWaitRrcConnMsgMmcCoverageLostInd(
                    VOS_UINT32                              ulMsgId,
                    VOS_VOID                                *pMsg);
