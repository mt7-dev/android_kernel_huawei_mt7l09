...
#define NAS_LMM_LOG_WARN(SubModId, String)            LPS_LOG(UE_MODULE_MM_ID, SubModId, NAS_LOG_LEVEL_WARNING, String)
#define NAS_LMM_LOG_ERR(SubModId, String)             LPS_LOG(UE_MODULE_MM_ID, SubModId, NAS_LOG_LEVEL_ERROR, String)
...
#define NAS_LMM_LOG1_WARN(SubModId, String, Para1)    LPS_LOG1(UE_MODULE_MM_ID, SubModId, NAS_LOG_LEVEL_WARNING, String, (long)Para1)
#define NAS_LMM_LOG1_ERR(SubModId, String,  Para1)    LPS_LOG1(UE_MODULE_MM_ID, SubModId, NAS_LOG_LEVEL_ERROR, String, (long)Para1)
...
#define NAS_LMM_LOG2_WARN(SubModId, String, Para1, Para2)    LPS_LOG2(UE_MODULE_MM_ID, SubModId, NAS_LOG_LEVEL_WARNING, String, (long)Para1, (long)Para2)
#define NAS_LMM_LOG2_ERR(SubModId, String,  Para1, Para2)    LPS_LOG2(UE_MODULE_MM_ID, SubModId, NAS_LOG_LEVEL_ERROR,   String, (long)Para1, (long)Para2)
...
#define NAS_LMM_LOG3_WARN(SubModId, String, Para1, Para2, Para3)    LPS_LOG3(UE_MODULE_MM_ID, SubModId, NAS_LOG_LEVEL_WARNING, String, (long)Para1, (long)Para2, (long)Para3)
#define NAS_LMM_LOG3_ERR(SubModId, String,  Para1, Para2, Para3)    LPS_LOG3(UE_MODULE_MM_ID, SubModId, NAS_LOG_LEVEL_ERROR,   String, (long)Para1, (long)Para2, (long)Para3)
